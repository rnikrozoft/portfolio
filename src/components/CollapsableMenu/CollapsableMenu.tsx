...
export default function CollapsableMenu({ allApps }: { allApps: MDXEntry<App>[]}) {
  ...
  return (
    <div className={clsx(!expanded && 'hidden', 'z-10 bg-black absolute md:static left-full top-0 bottom-0 flex flex-col text-gray-500 border-r-2 border-r-dark_border min-w-[300px] max-w-[300px]')}>
